...
using namespace ChefEngine::DEMath::Constants;
...
namespace
{
    ...
    void SimpleDrawImpl::AddFace(const Vector3& v0, const Vector3& v1, const Vector3& v2, const Color& color)
    {
        ...
        {
            mFaceVerticies[mFaceVertexCount++] = VertexPC{ v0, color };
            mFaceVerticies[mFaceVertexCount++] = VertexPC{ v1, color };
            mFaceVerticies[mFaceVertexCount++] = VertexPC{ v2, color };
        }
    }
