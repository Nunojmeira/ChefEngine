...
using namespace ChefEngine::DEMath;

void GameState::OnCreateShape()
{
	mVerticies.push_back({ DEMath::Vector3(0.0f, 0.5f, 0.0f), Colors::Blue });
	mVerticies.push_back({ DEMath::Vector3(0.5f, -0.5f, 0.0f), Colors::Red });
	mVerticies.push_back({ DEMath::Vector3(-0.5f, -0.5f, 0.0f), Colors::Yellow });

	mVerticies.push_back({ DEMath::Vector3(-0.5f, -0.5f, 0.0f), Colors::Yellow });
	mVerticies.push_back({ DEMath::Vector3(-1.0f, 0.5f, 0.0f), Colors::Red });
	mVerticies.push_back({ DEMath::Vector3(0.0f, 0.5f, 0.0f), Colors::Blue });

	mVerticies.push_back({ DEMath::Vector3(0.0f, 0.5f, 0.0f), Colors::Blue });
	mVerticies.push_back({ DEMath::Vector3(1.0f, 0.5f, 0.0f), Colors::Yellow });
	mVerticies.push_back({ DEMath::Vector3(0.5f, -0.5f, 0.0f), Colors::Red });
}
